...
```bash
npx netlify-cli env:set KEY "VALUE" --context production           # add / fix
npx netlify-cli env:set KEY "VALUE" --context production --secret  # sensitive values: write-only in the Netlify UI
