...
| Background function                    | 15 minutes; immediate 202; retry after one minute, then after two more                                                             | First used by `reconcile-ledgers-background` (#1454), which drives the ledger reconcile in bounded chunks through its HTTP twin                                                            |
