...
**2026-09-16, vendor answer:** Netlify support (ticket #1112198) confirmed the stall as platform-side with no fix in flight and no provisioned concurrency on any plan; details in `platform-limits.md` under "What Netlify said". The interim keep-warm (five parallel pings per tick, `KEEP_WARM_CONCURRENCY`) shipped the next day; the hosting decision is ADR 32.
