...
| `LOAD_GATE_AUTH_TOKEN`                                              | load-gate.yml                                 | Pre-minted Better Auth session cookies for the buyer accounts (`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `-separated). Without it the harness falls back to email sign-in and the 10-per-15-minute sign-in limiter caps the run at a handful of sessions. |
