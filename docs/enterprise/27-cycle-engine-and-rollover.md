...
([ledger integrity](14-ledger-integrity.md)) asserts no gap/overlap between a
...
- **Contract expire / terminate** — closes assignments to `CLOSED` (see
  [contract lifecycle](26-contract-lifecycle.md)); the cron will not later
...
check ([ledger integrity](14-ledger-integrity.md)) is the backstop.
...
- [Programs](21-programs.md) — assignment accounting, caps, the claim helper.
- [Contract lifecycle](26-contract-lifecycle.md) — the contract state the
  decision table reads.
- [Concurrency & idempotency](20-concurrency-and-idempotency.md) — the claim
  gates + unique constraints as idempotency anchors.
- [Invoicing](12-invoicing.md) — CHARGE_ORG overage settlement at cycle close.
- [Ledger integrity](14-ledger-integrity.md) — the reconcile/drift checks.
