...
- **Outbound webhooks** — `/webhooks` CRUD + `[endpointId]/rotate-secret`,
  ...
  OWNER / OWNER ∨ BILLING_ADMIN / MANAGER — see `40-api-reference.md`).
...
- `40-api-reference.md` — the live route table with min-roles and
  audit actions.
- `03-roles-and-permissions.md` — role catalog + the `MemberRoleSchema`
  narrowing pattern at the API boundary.
- `09-wallet-and-topups.md` — credit-pool → wallet migration.
