...
in the override chain (see `10-booking-to-earnings.md`). Use cases:
...
See `03-roles-and-permissions.md` for the policy and its UX copy.

## Related docs

- `10-booking-to-earnings.md` — rate-card resolution and the
  `payoutRecipient` fork.
- `03-roles-and-permissions.md` — where EXPERT sits on the rank ladder
  and the LEARNER ↔ EXPERT disjoint rule.
- `11-payout-pipeline.md` — how EXPERT earnings reconcile.
- `24-public-pages-and-discovery.md` — how the explore surface surfaces
  org-hosted experts.
