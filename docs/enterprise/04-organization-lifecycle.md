...
2. Creates the `Organization` with `status = PENDING_VERIFICATION`. The
   ...
   [05-hierarchy.md](05-hierarchy.md)).
...
active lists. See [02-funding-and-programs.md](02-funding-and-programs.md).
...
- `15-sso-and-authentication.md` — SSO enforcement for
  PENDING_VERIFICATION orgs.
- `21-programs.md` — the program subtypes behind this lifecycle.
