# Preplaced.in - Deep Dive Competitor Analysis

> **Last Updated:** December 2024
> **Competitor Type:** Indirect Competitor (Long-term Tech Mentorship)
> **Threat Level:** MEDIUM
...
> "Supercharge your career with 1:1 Long Term Mentorship"
> "Mentorship till you Get Placed"

Preplaced is an open marketplace mentorship platform focused on job preparation, connecting mentees with industry mentors for long-term career guidance and interview preparation.

### 2.2 Unique Selling Points

1. **Long-term Commitment**: 3-6 month mentorship programs (not one-off sessions)
2. **Placement Guarantee**: "Mentorship till you Get Placed" promise
3. **Job Referrals**: Mentors provide referrals to their companies
4. **Trial Sessions**: Free trial before commitment
5. **Tech Focus**: Specialized in tech/engineering careers
...
- **Chat Support**: Async communication with mentor
- **Weekly Sessions**: Regular 1:1 video calls
...
- **Mentor-set Pricing**: Mentors determine their own rates
- **Platform Commission**: Percentage of mentor fees (exact % undisclosed)
- **No Subscription**: Pay per mentorship engagement
...
```
1. Browse Mentors → 2. Apply Filters → 3. Select Mentor
         ↓
4. Book Trial Session (Free) → 5. Evaluate Fit
         ↓
6. Commit to Long-term → 7. Planning Session
         ↓
8. Weekly Sessions → 9. Mock Interviews → 10. Get Placed
```

### 4.2 How It Works

1. **Discovery**: Share requirements, goals, background
2. **Matching**: Platform suggests best mentors
3. **Trial**: Free session to evaluate mentor
4. **Planning Session**: Mentor assesses current level, creates roadmap
5. **Execution**: Weekly sync-ups, task assignments, resources
6. **Support**: Chat for async questions, motivation
7. **Mock Interviews**: Real interview simulation
8. **Placement**: Job referrals through mentor network
...
- "Made significant progress with mentor's guidance"
...
### 5.1 Mentor Selection Process

> "Mentors go through a rigorous selection process to maintain high standard of mentorship."
...
- **Tier 1, 2, 3 Companies**: Across industries

### 5.3 Mentor Value Proposition

- Set their own pricing
- Flexible scheduling
- Help candidates get placed (mission-driven)
- Provide referrals to their companies
...
- Primary: India
- Target Companies: Global (MAANG, top tech)

### 7.3 Positioning Statement

> "India's leading 1:1 long-term mentorship platform for tech career success"
...
4. **Integrated experience**: Video + chat in one platform
5. **Multiple revenue streams**: For consultants
...
1. **Broader Expertise**: Position as "Preplaced for ALL domains"
2. **Flexible Options**: "From 1 session to 6-month programs"
3. **Integrated Platform**: "No Zoom links, no app switching"
4. **Creator Tools**: "Build your knowledge business"
...
4. Free trial reduces commitment anxiety
...
- [Preplaced Official Website](https://www.preplaced.in/)
- [Preplaced Explore Mentors](https://www.preplaced.in/explore-mentors)
- [Preplaced Become a Mentor](https://www.preplaced.in/become-a-mentor)
- [Preplaced Mentorship Fees](https://www.preplaced.in/blog/preplaced-mentorship-fees)
- [Preplaced Success Roadmap](https://www.preplaced.in/blog/1-1-end-to-end-interview-preparation-program-roadmap-at-preplaced)
- [Preplaced Day in the Life](https://www.preplaced.in/blog/a-day-in-the-life-of-a-preplaced-mentee)
...
- [MentorCruise Best Platforms](https://mentorcruise.com/blog/we-uncovered-5-best-platforms-for-career-tech-mentorship/)
