# GrowthSchool.io - Deep Dive Competitor Analysis

> **Last Updated:** December 2024
> **Competitor Type:** Indirect Competitor (Cohort-based Learning Platform)
> **Threat Level:** MEDIUM
...
- Tanmay Bhat (Creator)
- Austen Allred (Lambda School Founder)
- Shaan Puri (Twitch exec)
...
- **Role**: Founder & CEO since 2021
- **Angel Investments**: Phot.AI, House of X, Komet, Shardeum
- **Personal Brand**: LinkedIn thought leader
...
> "Become the top 1% - Learn in-demand skills to land your dream job"

GrowthSchool bridges the gap between traditional education and practical skills demanded by today's job market.
...
- **India vs. International**: "$150 in India but $3,100 for international buyers" (reported)
- **Subscription Model**: Annual access to sessions
- **Upsell Flow**: Free workshop → Crash course → Extensive program
...
```
1. Free Workshop (Lead magnet)
         ↓
2. Small Paid Course (₹5-10K)
         ↓
3. Extensive Program (₹15-70K)
         ↓
4. Annual Subscription (₹5-18K/year)
```
...
- "Great for LinkedIn and AI-focused learning"
...
- "40% of session time was just promotion"
- "Refused to pay back ₹41,000 fees for refund request"
- "Employs every manipulative marketing tactic imaginable"
- "AI lessons are insultingly basic"

### 5.2 Trustpilot Presence

- **Reviews**: 6,326+ customer reviews
- **Rating**: Mixed (polarized)
- **Primary Domain**: sisinty.com (Vaibhav's personal brand)
...
> "Community-led live learning platform for job-relevant skills"

GrowthSchool positions itself as the bridge between education and employability, with emphasis on practical skills and fast outcomes.
...
4. Celebrity/investor endorsements
...
4. Promotional content in sessions
5. Basic content marketed as advanced
...
4. Founder personal brand
5. Free content funnel
...
5. Document review feature
6. Subscription + one-off options
...
Learn from their growth tactics, avoid their reputation issues.
...
- [GrowthSchool Official Website](https://home.growthschool.io/)
- [GrowthSchool About Page](https://home.growthschool.io/about-us)
- [GrowthSchool Wall of Love](https://home.growthschool.io/wall-of-love)
- [GrowthSchool Trustpilot](https://www.trustpilot.com/review/growthschool.io)
- [Vaibhav Sisinty Trustpilot](https://www.trustpilot.com/review/sisinty.com)
...
- [GrowthSchool 400% Growth - CXOToday](https://cxotoday.com/press-release/gen-ai-led-upskilling-platform-growthschool-achieves-400-yoy-revenue-growth-targets-1-million-monthly-run-rate-by-fy-2024/)
- [Traffic Tail Success Story](https://traffictail.com/startups/growthschool-success-story/)
- [Vaibhav Sisinty Executive India](https://theexecutiveindia.com/vaibhav-sisinty-the-edtech-revolutionary-bridging-indias-skill-gap-with-growthschool/)
- [Quora GrowthSchool Reviews](https://www.quora.com/Is-GrowthSchool-a-scam-can-I-trust-their-workshops-and-programs)
