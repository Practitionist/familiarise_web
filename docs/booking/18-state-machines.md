...
| **REJECTED**                 | ✓                                               |                                                              | ✓                                                                                                         |           |           |          |           |         |
| **CANCELLED**                | ✓                                               | ✓                                                            | ✓                                                                                                         | ✓         |           |          |           |         |
| **EXPIRED**                  | ✓ (48 h consultation / 30 d subscription sweep) | ✓ (PR 2c: APPROVED-unallocated cohort)                       | ✓ (24 h pay-link window since #1724, plus the 7 d `updatedAt` fallback in `expirePaymentPendingRequests`) |           |           |          |           |         |
