...
| Engagement debits + caps                             | `lib/payments/operations/checkout.ts`, `recordBookingUtilization()`; lazy SUBSCRIPTION debit in `SlotAllocationService.createAppointments`                                      |
