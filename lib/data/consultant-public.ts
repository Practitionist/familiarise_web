...
export const consultantPublicScalars = {
  ...
  scheduleType: true,
  // #1703 D1/D4 — how the consultant takes bookings; not PII.
  bookingMode: true,
...
export const consultantPublicApiSchema = z
  .object({
    ...
    bookingMode: z.string().nullish(),
    acceptingRequests: z.boolean().nullish(),
    maxOpenRequests: z.number().int().nullish(),
