 ...
 * - MAINTAINER + canSponsor gate, org must not be SUSPENDED/DEACTIVATED.
...
export async function POST(
  ...
  // Cross-org guard: program must belong to this org (belt-and-braces vs
  // guessing programIds of sibling tenants).
