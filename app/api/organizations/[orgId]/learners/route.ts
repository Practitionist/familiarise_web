 ...
 *
 * File: app/api/organizations/[orgId]/learners/route.ts
 */
  ...
  return NextResponse.json(
    {
      ...
      detail: `${method} app/api/organizations/[orgId]/learners/route.ts is awaiting Arch 4-Modified rewrite; see Issue #681.`,
    },
    { status: 501 },
  );
}
