 ...
 *
 * File: app/api/organizations/[orgId]/billing/invoices/route.ts
 */
  ...
  return NextResponse.json(
    {
      ...
      detail: `${method} app/api/organizations/[orgId]/billing/invoices/route.ts is awaiting Arch 4-Modified rewrite; see Issue #681.`,
    },
    { status: 501 },
  );
}
