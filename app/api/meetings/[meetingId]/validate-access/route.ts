...
export async function GET(
    ...
    try {
        ...
        if (appointment.consultation?.consultationPlan?.consultantProfileId) {
            consultantProfileId = appointment.consultation.consultationPlan.consultantProfileId;
        } else if (appointment.subscription?.subscriptionPlan?.consultantProfileId) {
            consultantProfileId = appointment.subscription.subscriptionPlan.consultantProfileId;
        ...
        const isHost = userProfile?.consultantProfileId === consultantProfileId && !!consultantProfileId;
