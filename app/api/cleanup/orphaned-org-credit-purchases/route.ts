 ...
 *
 * File: app/api/cleanup/orphaned-org-credit-purchases/route.ts
 */
  ...
  return NextResponse.json(
    {
      ...
      detail: `${method} app/api/cleanup/orphaned-org-credit-purchases/route.ts is awaiting Arch 4-Modified rewrite; see Issue #681.`,
    },
    { status: 501 },
  );
}
