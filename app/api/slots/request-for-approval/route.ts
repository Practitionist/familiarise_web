...
export async function POST(req: NextRequest) {
    try {
        ...
        if (!consultantProfileId || !slotStartTimeInUTC || !slotEndTimeInUTC || !consultationPlanId) {
            return NextResponse.json(
        ...
        const requestNotes = `Request for approval - Slot: ${startTime.toISOString()} to ${endTime.toISOString()}. ` +
