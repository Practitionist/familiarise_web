            ...
            <div className="relative">
              ...
              <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg">
                <ul className="py-1 overflow-auto max-h-60">
                  <li className="px-3 py-2 hover:bg-gray-100 cursor-pointer text-black">NLP</li>
                  <li className="px-3 py-2 hover:bg-gray-100 cursor-pointer text-black">Leadership</li>
                  <li className="px-3 py-2 hover:bg-gray-100 cursor-pointer text-black">Taxes</li>
                  <li className="px-3 py-2 hover:bg-gray-100 cursor-pointer text-black">AI</li>
                  <li className="px-3 py-2 hover:bg-gray-100 cursor-pointer text-black">Machine Learning</li>
                </ul>
              </div>
            </div>
