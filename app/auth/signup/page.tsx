...
export default function SignUp() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Account Created Successfully!", description: "Signing you in..." });
      ...
      if (signInResult?.error) {
        ...
        toast({ title: "Sign In Failed After Signup", description: "Unknown error.", variant: "destructive" });
        router.push("/auth/signin");
      }
      ...
      <div className="flex-1 md:w-1/2 bg-white text-black p-6 md:p-12 flex flex-col justify-between">
         <Link href="/">
           <div className="flex items-center justify-start space-x-2">
             ...
             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-black w-5 md:w-6 h-5 md:h-6"><circle cx="12" cy="12" r="10" /><line x1="2" x2="22" y1="12" y2="12" /><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" /></svg>
             <h1 className="text-2xl md:text-4xl font-semibold">ConsultX</h1>
           </div>
         </Link>
         <div className="my-8 md:my-0">
           <blockquote className="text-sm md:text-base">
             "Joining ConsultX was the best decision for my startup. Access to top-tier mentors gave us the clarity and direction we desperately needed."
           </blockquote>
         ...
         <div className="text-xs md:text-sm">
           Start your journey with ConsultX today. Sign up to unlock a world of expert mentorship.
         </div>
       </div>
      ...
      <div className="flex-1 md:w-1/2 bg-gray-900 text-white p-6 md:p-12 flex flex-col justify-center mt-auto md:mt-0">
        <div className="flex flex-col p-4 md:p-20">
          ...
          <p className="text-xs text-gray-400 mt-4 md:mt-6">
            ...
            <Link href="/auth/signin" className="font-medium text-blue-400 hover:underline">
                Sign in
            </Link>
          </p>
           <p className="text-xs text-gray-400 mt-2">
             By clicking Create Account, you agree to our Terms of Service and Privacy
             Policy.
           </p>
        </div>
      </div>
