    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "If a session's host is absent for at least 15 minutes of the booked time, or for half of it on sessions shorter than 30 minutes, the session is voided. For a one-to-one consultation, a host no-show is refunded in full automatically. For subscriptions, classes and webinars, we first offer a free make-up session within 14 days; if it goes unused, that session is refunded automatically, and any voided session that's still unused when your plan or billing cycle ends is also refunded automatically. If you miss the session as the learner, no refund applies, but you'll get a support link — and a link to the recording, when your plan records sessions — in case something on our side kept you out; support can review and correct the outcome if it was recorded incorrectly. Sessions held outside the platform are marked inconclusive and handled case by case — contact support with evidence.",
        ],
      },
    ],
  },
