...
export default function Page() {
  ...
  // Verify-only page — don't expose the externally-triggerable error generator
  // in production (hooks above run unconditionally to satisfy rules-of-hooks).
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://practitionist.sentry.io/issues/?project=4511593990914048"
          >
            Issues Page
          </a>
