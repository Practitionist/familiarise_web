...
import { SlotOfAvailability, filterSlotsByDay, formatSlotTime, calculateSlotPosition } from '../utils';
...
export const WeekView: React.FC<WeekViewProps> = ({ currentDate, slots, onCellClick }) => {
