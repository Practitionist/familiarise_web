 ...
 */
export function getAppointmentTimingDetails(appointment: TAppointment): AppointmentTimingDetails {
 ...
 */
export function canManageAppointmentTimings(appointment: TAppointment): boolean {
