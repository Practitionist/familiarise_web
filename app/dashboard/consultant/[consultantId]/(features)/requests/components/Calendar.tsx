          ...
          {DAYS.map((day, index) => {
            ...
            return (
              <div key={day} className="text-center p-1 md:p-2">
                ...
                <div className="text-xs md:text-sm text-muted-foreground">{date.getDate()}</div>
              </div>
            )
          })}
        </div>
          ...
          return (
            ...
            >
              <CardContent className="p-0.5 md:p-1 h-full flex flex-col">
                <div className={`font-bold bg-background/95 backdrop-blur p-1 flex justify-between items-center text-xs md:text-sm ${
    ...
    <div className="flex flex-col h-full max-w-[100vw] overflow-x-hidden">
      ...
      <div className="mt-1 md:mt-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-1 md:gap-0">
          <div className="text-xs md:text-sm">Selected: {selectedSlots.length} / {requiredSlots}</div>
