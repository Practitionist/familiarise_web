      ...
      <div className="flex h-[calc(100vh-280px)] w-full bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="w-1/3 border-r">
          ...
          <div className="h-[calc(100%-4rem)] overflow-y-auto">
            {['John Doe (Consultant)', 'Jane Doe (Consultant)', 'Bob Smith (Consultant)', 'Sarah Johnson (Consultant)'].map((name, index) => (
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {[
              { text: "Hello, how can I assist you today?", sender: 'them', time: '2:30 PM' },
              { text: "Hi, I have a question about my upcoming consultation.", sender: 'me', time: '2:31 PM' },
              { text: "Of course, I'd be happy to help. What would you like to know?", sender: 'them', time: '2:32 PM' },
              { text: "I was wondering if we could reschedule for next week.", sender: 'me', time: '2:33 PM' },
            ].map((message, index) => (
