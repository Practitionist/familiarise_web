...
export default function WaitlistsPage() {
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    {isPast ? (
                      <Badge className="bg-red-100 text-red-800 border-red-300 dark:bg-red-900/30 dark:text-red-300 dark:border-red-800">
                        Event Ended
                      </Badge>
                    ) : isNotified ? (
                ...
                {!isPast && isNotified && entry.expiresAt && (
                  <div className="mt-3 p-3 bg-green-100 rounded-lg dark:bg-green-900/30">
  ...
  const renderSection = (
    ...
    return (
      <motion.div variants={fadeInUp}>
        ...
        {ended.length > 0 && (
          <div className="mt-6">
            <h3 className="text-sm font-medium text-muted-foreground/70 uppercase tracking-wider mb-3">
              Ended
            </h3>
            <div className="space-y-4">
  ...
  return (
    ...
    >
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-4">
              {/* Decorative icon chip — neutral monochrome, not a status accent */}
      ...
      {/* Scope note — off-brand blue banner collapsed to neutral monochrome */}
      <motion.div variants={fadeInUp}>
        <div className="flex items-start gap-2.5 rounded-lg border border-border bg-muted px-4 py-3 text-sm text-muted-foreground">
