...
async function fetchInvoices(page: number, limit: number, search?: string) {
...
export default function StaffInvoicesPage() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["staff-invoices", page, search],
    queryFn: () => fetchInvoices(page, limit, search),
    staleTime: 60 * 1000,
  });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            View platform payment invoices
          </p>
        </div>
