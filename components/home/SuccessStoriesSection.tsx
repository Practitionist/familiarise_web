        ...
        <CardContent className="p-6 md:p-8">
          <div className="flex items-center gap-4 mb-6">
            <Avatar className="w-14 h-14 border-2 border-zinc-700">
              ...
              <AvatarFallback className="bg-zinc-800 text-white">{story.name.charAt(0)}</AvatarFallback>
            </Avatar>
            <div>
          ...
          <p className="text-zinc-300 mb-6 leading-relaxed">&ldquo;{story.story}&rdquo;</p>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Real transformations, <span className="text-zinc-400">real results</span>
          </h2>
